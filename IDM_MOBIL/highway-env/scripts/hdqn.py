...
def hdqn_learning(
    ...
    check_frequence=5
    beta_start = 2.0  # Initial value of beta
    beta_end = 0   # Final value of beta
    ...
    for i_thousand_episode in range(n_thousand_episode):
        ...
        for i_episode in range(check_frequence):
            ...
            while not done:
                ...
                # maybe we should consider using the same entropy
                ...
                if overall_episode <= annealing_episodes:
                    # Linearly anneal beta during the first 500 episodes
                    newbeta = beta_start + (beta_end - beta_start) * (overall_episode / annealing_episodes)
                else:
                    # After 500 episodes, beta stays constant at beta_end
                    newbeta = 0
                ...
                agent.update_controller(offline_replay, online_replay)
