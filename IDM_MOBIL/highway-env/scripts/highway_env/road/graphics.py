...
class RoadGraphics(object):
    ...
    @staticmethod
    def display(road: Road, surface: WorldSurface,reward,accu_reward,current_Goal) -> None:
        """
        ...
        str1 =  'accumulated reward:' + str(accu_reward)
        str2="immediate reward:"+str(reward)
        str3='current goal:'+str(current_Goal) 
        notice1=pygame.font.Font(None,30)
        text1=notice1.render(str1,True,(255,0,0))
        text2=notice1.render(str2,True,(255,0,0))
        text3=notice1.render(str3,True,(255,0,0))
        #[length,width]
        surface.blit(text1,[10,90])
        surface.blit(text2,[10,110])
        surface.blit(text3,[10,130])
