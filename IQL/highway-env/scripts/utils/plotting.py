...
EpisodestatsStats = namedtuple("Stats",["episode_lengths", "episode_rewards",
                                   ...
                                   "episode_crash","episode_min_headway","episode_min_ttc",
                                   "episode_max_lateral_jerk","episode_lane_invasion"])
...
def plot_episode_stats(stats, smoothing_window=5, mean_number=10, noshow=False):
    ...
    plt.title("Minimum Headway per Episode")

    fig8 = plt.figure(figsize=(10,5))
    plt.plot(stats.episode_min_ttc)
    plt.xlabel("Episode")
    plt.ylabel("Min TTC (s)")
    plt.title("Minimum TTC per Episode")

    fig9 = plt.figure(figsize=(10,5))
    plt.plot(stats.episode_max_lateral_jerk)
    plt.xlabel("Episode")
    plt.ylabel("Max Lateral Jerk (m/s^3)")
    plt.title("Maximum Lateral Jerk per Episode")

    fig10 = plt.figure(figsize=(10,5))
    plt.plot(stats.episode_lane_invasion)
    plt.xlabel("Episode")
    plt.ylabel("Lane Invasion Time (s)")
    plt.title("Lane Invasion Duration per Episode")
