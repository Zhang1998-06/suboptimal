...
class GOAL(DiscreteAction):
    ...
    def pre_act(self) -> None: 
        # perform the highlevel action without executing the highlevel action 
        # input is the highlevel action, output is the low-level action without execution 
        #
        return self.controlled_vehicle.act_goal() # this will lead to act in controller.py
